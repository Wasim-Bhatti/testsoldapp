  ...
  return (
    <div className="left-column">
      <div className="box">
        ...
        <p>The payout spectrum is a transparent visualization of how we can reward you for your work. The more difficult the prompt, the higher the payout. Another crucial piece of information
